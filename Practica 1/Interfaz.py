...
def saveCondic():
    ...
    with open('celulasIniciales.txt', 'wb') as f:
        np.savetxt(f, np.column_stack(celulasIniciales), fmt='%1.10f')
...
labelEspecifico = tkinter.Label(frameMainInformacion, text = "Indices to fill in with 1's or \n probability of 1, use % at the end: " , font=("times new roman", 14))
